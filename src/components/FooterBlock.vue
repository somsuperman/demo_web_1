<template>
  ...
  <LogoBlock :logoClass="'mx-auto w-40 lg:hidden'"/>
      ...
      <div class="flex flex-col sm:flex-row flex-wrap w-full mt-8 space-y-7 sm:space-y-0 lg:gap-20">
        ...
        <div class="sm:w-1/2 lg:w-1/5 lg:order-2">
          ...
          <ul class="text-gray-500 dark:text-gray-400 font-medium gap-3 grid">
            ...
            <li>
              <router-link to="/about-us" class="underline hover:no-underline">About</router-link>
            </li>
            <li>
              <router-link to="/services" class="underline hover:no-underline">Services</router-link>
            </li>
          </ul>
        </div>
        ...
        <div class="lg:w-2/5 lg:order-1">
          ...
          <ul class="mt-1 sm:mt-8 leading-5">
            ...
            <li>Services Authority</li>
            <li>License No.: BFX2024008</li>
            <li>Reg. No: HA00124732</li>
            <li>Address: Bonovo Road – Fomboni, Island of Mohéli – Comoros Union</li>
