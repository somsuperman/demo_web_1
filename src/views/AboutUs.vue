...
import OurVisionBlock from "../components/OurVisionBlock.vue";
...
.route-aboutus {
  .hero-bg {
    @apply before:-z-10 before:absolute before:h-full before:md:max-h-[600px] before:lg:max-h-[902px] before:left-0 before:right-0 before:bg-[url('img/about-us/about-us-bg.webp')] before:bg-left-top before:lg:bg-[-10rem_top] before:xl:bg-top before:md:bg-cover before:bg-no-repeat before:bg-[length:190%] before:sm:bg-[length:150%] before:lg:bg-cover before:xl:bg-cover before:2xl:bg-contain;
  }
}
</style>
