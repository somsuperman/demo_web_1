  ...
  <main class="max-w-[1260px] mx-auto py-8">
    ...
    <section class="hero ml-auto relative max-w-md sm:max-w-2xl lg:max-w-lg mx-auto lg:mr-0 2xl:pb-10">
      ...
      <p class="text-white tk-oscine sm:text-lg sm:leading-relaxed max-w-lg">
        From general inquiries to technical support, we’re here to help. Fill out our contact form, and one of our
        representatives will get in touch with you promptly.
      </p>
